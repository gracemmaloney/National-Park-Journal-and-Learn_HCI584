...
class App(Frame):
    ...
    def enter_new_journal_entry(self):
        ...
        # CH why not have an "empty" label here that gets later used to show a uploaded image?
        self.pic_label = Label(self.textframe)
        self.pic_label.pack(padx=10, anchor=W)
    ...
    def upload_image(self):
        ...
        image_resize = image_open.resize((300, 225), Image.LANCZOS)  # CH Image.Resampling.LANCZOS
        # CH better? use thumbnail instead of resize to preserve the original aspect ratio?
    ...
    def save_clicked_file(self):
        ...
        #self.click_journal_file = open(self.click_journal_file, 'w') # maybe use w+ to overwrite
